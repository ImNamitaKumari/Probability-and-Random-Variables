...
\section{solution}
Let X be the random variable denoting the number of successes in $n$ trials. X follows a Binomial Distribution. Let $p$ be the probability of success in each trial. Then, $(1-p)$ is the probability of failure in each trial.
\bigbreak
As per question,
\begin{align}
...
\end{align}
For the given question, $n=6$ and $p=2/3$.
\begin{align}
